...
export default function DeLandPage() {
  return (
    <div className="flex min-h-screen flex-col">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-start">
            <div className="space-y-6">
              <div className="inline-flex items-center rounded-full bg-white/10 px-3 py-1 text-sm">
                ...
                <span>DeLand, FL Vinyl Fencing Experts</span>
              </div>
              ...
              <p className="text-xl">
                Royalty Fence delivers hurricane-resistant vinyl fencing solutions specifically designed for DeLand
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start gap-2">
                  <Check className="h-5 w-5 text-royal-gold mt-1 flex-shrink-0" />
                  <span>Local DeLand installation team</span>
                </li>
                <li className="flex items-start gap-2">
                  <Check className="h-5 w-5 text-royal-gold mt-1 flex-shrink-0" />
            ...
            <div className="relative">
              <div className="relative rounded-lg overflow-hidden shadow-2xl">
                {(() => {
                  const imageSrc = "/before-storm-1.jpg"
        ...
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-royal-blue mb-4">
              Why DeLand Homeowners Choose Our Vinyl Fencing
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Designed specifically for DeLand's historic neighborhoods and built to last through Florida's toughest
              weather
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-50 rounded-xl p-6 shadow-lg">
              ...
              <p className="text-gray-700">
                Our vinyl fences are engineered to withstand DeLand's hurricane season with wind ratings up to 150mph.
              </p>
            </div>
            ...
            <div className="bg-gray-50 rounded-xl p-6 shadow-lg">
              ...
              <h3 className="text-xl font-bold text-royal-blue mb-3">Historic District Compatible</h3>
              <p className="text-gray-700">
                Styles that complement DeLand's historic homes while providing modern durability and low maintenance.
              </p>
            </div>
            ...
            <div className="bg-gray-50 rounded-xl p-6 shadow-lg">
              ...
              <p className="text-gray-700">
                Our team knows DeLand's soil conditions, permit requirements, and neighborhood regulations.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-royal-blue mb-4">What DeLand Residents Say</h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-xl p-6 shadow-lg">
              ...
              <p className="text-gray-700 mb-4 italic">
                "We needed a fence that would complement our historic DeLand home while still being practical. Royalty
                Fence delivered exactly what we wanted - a beautiful vinyl fence that looks like traditional wood but
                requires zero maintenance."
              </p>
              <div>
                <p className="font-bold">Robert S.</p>
                <p className="text-sm text-gray-500">Historic District, DeLand</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg">
              ...
              <p className="text-gray-700 mb-4 italic">
                "After losing our fence during a storm, we called Royalty Fence for a replacement. Their vinyl fence has
                survived two hurricane seasons without a scratch. Their knowledge of DeLand's building codes made the
                permit process painless."
              </p>
              <div>
                <p className="font-bold">Sarah M.</p>
                <p className="text-sm text-gray-500">Victoria Hills, DeLand</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-royal-blue text-white">
        <div className="container text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready for a Premium Vinyl Fence in DeLand?</h2>
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Get a free, no-obligation estimate for your DeLand property. Our team will help you choose the perfect vinyl
            fence solution.
          </p>
